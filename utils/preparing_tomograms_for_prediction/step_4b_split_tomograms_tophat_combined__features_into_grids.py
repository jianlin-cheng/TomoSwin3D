...
def main():
    ...
    default_output_dir = repo_root / "sample_input_data" / "test_data" / "Grids_64_normalized" / "tomograms_feature_maps_tophat_combined"
    ...
    for i, directory in enumerate(BASE_DIR):
        ...
        normalized_map = f"{directory}/tomogram_feature_maps/tomogram_filter_tophat_combined.mrc" #change this to class_mask_standardized_across_all_dataset.mrc
