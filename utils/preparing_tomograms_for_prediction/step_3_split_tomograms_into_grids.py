...
def main():
    ...
    default_output_dir = repo_root / "sample_input_data" / "test_data" / "Grids_64_normalized" / "tomograms"
    ...
    for i, directory in enumerate(BASE_DIR):
        ...
        normalized_map = f"{directory}/reconstruction_normalized_map.mrc" #change this to class_mask_standardized_across_all_dataset.mrc
